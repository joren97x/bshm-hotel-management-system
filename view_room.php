    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && empty($missing_data)) { 
        ...
        // echo "Check-in Date: " . $check_in_date->format('D, M j, Y g:i A') . "<br>";
        // echo "Check-out Date: " . $check_out_date->format('D, M j, Y g:i A') . "<br>";
    
        // Allow bookings if:
        // - Check-in and check-out are on the same day, with valid time difference
        // - Check-out is on the next day
        if ($check_out_date < $check_in_date || ($days === 0 && $hours <= 0)) {
            echo "
            ...
            <script>
                Swal.fire({
                    ...
                    text: 'Check-out date must be today or tomorrow and after check-in time.',
        ...
        $total_price = max($days, 1) * $room_price;
            ...
            <div class="col-lg-5">
                <form method="POST" action="">
                    <div class="border p-3 rounded shadow-sm">
                        ...
                        <button class="btn reserve-btn w-100 btn-primary" type="submit">Book now</button>
                    </div>
                </form>
