...
-- Password:   `password`
--
DROP DATABASE IF EXISTS hm_hotels;
CREATE DATABASE IF NOT EXISTS hm_hotels;

DROP USER IF EXISTS'hm_student'@'%';
CREATE USER IF NOT EXISTS 'hm_student'@'%' IDENTIFIED BY 'password';
GRANT ALL PRIVILEGES ON hm_hotels.* TO 'hm_student'@'%';
USE hm_hotels;
