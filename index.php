...
<style>
    /* Hero Section */
     ...
     .hero {
        ...
        text-align: center;
        overflow: hidden;
        background-image: url('./image/homepage1.jpg'); 
...
<div class="hero">
    <div class="hero-images">
        <div class="hero-slide" style="background-image: url('./image/homepage1.jpg');"></div>
        <div class="hero-slide" style="background-image: url('./image/homepage2.jpg');"></div>
        <div class="hero-slide" style="background-image: url('./image/homepage3.jpg');"></div>
